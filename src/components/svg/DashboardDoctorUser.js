...
function Root() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M11.46 13.73C13.0119 13.73 14.27 12.4719 14.27 10.92C14.27 9.36806 13.0119 8.10999 11.46 8.10999C9.90809 8.10999 8.65001 9.36806 8.65001 10.92C8.65001 12.4719 9.90809 13.73 11.46 13.73Z"
        stroke="#fff"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M20.49 4.97998H17.51" stroke="#fff" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M19 3.52002V6.51001" stroke="#fff" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
const DashboardDoctorUser = forwardRef(Root);
export default DashboardDoctorUser;
