...
export default function RestaurantCheckIn() {
  const delay = 500;
      ...
      <MainCard>
        <Box style={styles.paperContainer}>
          <Box>
            ...
            >
              Scanning Code/Enter Meeting Code For Restaurant
            </Typography>
          </Box>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <Box sx={{ display: { md: 'flex' }, justifyContent: 'center', alignItems: 'center', my: 2 }}>
                  ...
                  <Box sx={{ ml: { xs: 0, md: 2 }, mt: { xs: 2, md: 0 }, width: { xs: '100%', md: '40%' } }}>
                    <Typography variant="h6">Restaurant Check-In Code *</Typography>
