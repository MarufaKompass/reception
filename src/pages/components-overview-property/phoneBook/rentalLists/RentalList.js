...
export default function RentalList({ rentalList }) {
  const { apartment_contactimage, apartment_contactname, apartment_contactphone, apartment_contactstatus, apartment_name } = rentalList;
  return (
